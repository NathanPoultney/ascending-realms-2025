...
var text_colour;
if (selected) {
    text_colour = c_white;  // Selected color
} else if (is_hovering) {
    text_colour = c_white;  // Hover color
} else {
    text_colour = c_gray;   // Default color
}

// Draw the text with the determined color
draw_text_color(x, y - 40, "Farm", text_colour, text_colour, text_colour, text_colour, 255);